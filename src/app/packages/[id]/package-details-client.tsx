...
export function PackageDetailsClient({ pkg, similarPackages = [] }: PackageDetailsClientProps) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-24 lg:pb-8">
            ...
            <div className="relative h-72 sm:h-80 md:h-[400px] lg:h-[450px]">
                <Image
                    src={pkg.image}
                    alt={`${pkg.destination} - ${pkg.name} tour package | Best prices from Golden Globe Tours`}
                    fill
                                        ...
                                        <Link key={similar.id} href={`/packages/${similar.id}`}>
                                            <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
                                                <div className="relative h-32">
                                                    <Image
                                                        src={similar.image}
                                                        alt={`${similar.destination} - ${similar.name} tour package`}
                                                        fill
